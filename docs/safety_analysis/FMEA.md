...
| F-004 | watchdog_server | Seed not generated (Python exception) | No seed sent to Pi5 | Pi5 has no seed to respond to; Pi400 own timer fires → failure_counter++ | Pi400 internal timeout | Medium | Low | Exception handler restarts loop; fail-safe: GPIO 25 remains LOW |
